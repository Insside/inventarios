...
$ret = array();
$p->addContent("\n<!--{$sql}//-->");
$p->addContent("\n<table data-role=\"table\" id=\"tSolicitudes\" data-mode=\"columntoggle\" class=\"ui-body-d ui-shadow table-stripe ui-responsive\" data-column-button-theme=\"b\" data-column-button-text=\"Columns to display...\" data-column-popup-theme=\"a\">");
$p->addContent("<thead>");
$p->addContent("<th>Salida</th>");
$p->addContent("<th>Empleado</th>");
$p->addContent("<th>Estados</th>");
...
while ($fila = $db->sql_fetchrow($consulta)) {
    ...
    $url="/framework/modulos/inventarios/formularios/salida/consultar/mobile/salida.php?tid=".time()."&salida=";
