...
$html.="<div class=\"notificacion\"><p><b>Imposible revertir legalización {$legalizacion}.</b><br>";
...
/** JavaScripts **/
$f->setAudio(array("src"=>"modulos/inventarios/multimedia/audios/inventarios-solicitud-detalle-legalizacion-noreversible.mp3","autoplay"=>true));
$f->JavaScript("MUI.titleWindow($('" . ($f->ventana) . "'), \"Revertir Legalizacion - \");");
